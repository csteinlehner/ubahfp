...
public class SingleDataCirclePlot2 extends PApplet {
...
//	public static final String JDBC_CONN_STRING_MAC = "jdbc:sqlite:../data/uba6-13.mbtiles";
	...
	private Vector<SingleDataCircle2> datas = new Vector<SingleDataCircle2>();
	...
	public void setup() {
		  ...
		  for(Anlage a : positions){
			  datas.add(new SingleDataCircle2(this, a));
		  }
		}
